...
app.get('/app', passportConf.isAuthenticated, homeController.app);
...
app.get('/partyYes', partyController.getPartyYes);
app.get('/modeHappy', partyController.getModeHappy);
app.get('/modeWorried', partyController.getModeWorried);
